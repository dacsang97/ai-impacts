...
export const Slide1 = () => {
	...
	const outlineItems = [
		...
		{ id: 5, title: "4. AI Giúp Ích Ở Đâu (Phần 1)" },
		{ id: 6, title: "5. AI Giúp Ích Ở Đâu (Phần 2)" },
		{ id: 7, title: "6. AI Còn Hạn Chế Ở Đâu?" },
		{ id: 8, title: "7. Tăng Tốc Với AI: Thực Tế Là Bao Nhiêu?" },
		{ id: 9, title: "8. Quy Trình Kỹ Thuật Mới" },
		{ id: 10, title: "9. Tái Cấu Trúc Đội Nhóm" },
		{ id: 11, title: "10. Phá Vỡ Rào Cản Sản Phẩm & Kỹ Thuật" },
		{ id: 12, title: "11. AI Cần Gì Từ Tổ Chức?" },
		{ id: 13, title: "12. Giữ Vững Giá Trị Bản Thân (Phần 1)" },
		{ id: 14, title: "13. Giữ Vững Giá Trị Bản Thân (Phần 2)" },
		{ id: 15, title: "14. Kết Luận: Bạn Vẫn Nắm Giữ Nghề Nghiệp!" },
		{ id: 16, title: "15. Cảm Ơn!" },
	];
